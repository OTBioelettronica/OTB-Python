...
import numpy as np
import communication_quattro_plus as communication
...
# Create a socket which is used to connect to Quattro+
...
sample_from_channels = [0 for i in range(number_of_channels - 6)]
...
s = SoundTrack(number_of_channels - 6)
i = 0
