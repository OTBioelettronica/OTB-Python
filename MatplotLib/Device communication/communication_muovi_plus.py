#!python3
# -------------------------------------------------------
# Module to connect to Muovi signal data logger
#
import datetime
import multiprocessing
import socket  # We will need this for establishing the communication with Muovi
import numpy as np
...
# Connect to Muovi's TCP socket and send start command
def connect_to_sq(
        sq_socket,
        ip_address,
        port,
...
# Disconnect from Muovi by sending a stop command
